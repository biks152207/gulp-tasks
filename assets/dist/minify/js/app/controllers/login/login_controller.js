(function() {
    app.controller('loginController', ["$scope", "$stateParams", "$state", "$ionicLoading", "TodoZuDB", "user", "sharedData", "message", "userModel", "pushNotification", "connectivity", "$timeout", "$q", "$rootScope", function( $scope, $stateParams, $state, $ionicLoading, TodoZuDB,
