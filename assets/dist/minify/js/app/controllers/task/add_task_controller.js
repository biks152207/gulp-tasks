(function () {
    app.controller('addTaskController', ["$q", "$scope", "$rootScope", "$ionicModal", "$ionicPopup", "$timeout", "$state", "taskService", "dueService", "stringService", "headerService", "guidGenerator", "dbEnums", "reminderService", "sharedData", "project", "user", "labelService", "date", "message", "userModel", "roleValidators", "settingsService", "popupService", function ($q, $scope, $rootScope, $ionicModal, $ionicPopup, $timeout, $state,
