(function () {
    app.controller('accountSettingController', ["$rootScope", "$scope", "$state", "$ionicModal", "user", "settingsService", "stringService", "message", "userModel", "dbEnums", "connectivity", "$ionicLoading", function ($rootScope, $scope, $state, $ionicModal, user,
