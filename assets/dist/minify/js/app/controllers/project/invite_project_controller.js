(function () {
    app.controller('inviteProjectController', ["$rootScope", "$scope", "$state", "$ionicPopup", "$stateParams", "project", "sharedData", "message", "stringService", "dbEnums", "userModel", "roleValidators", function ($rootScope, $scope, $state, $ionicPopup, $stateParams, project,
