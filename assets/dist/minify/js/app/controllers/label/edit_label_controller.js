(function () {
    app.controller('editLabelController', ["$rootScope", "$state", "$scope", "$ionicModal", "$stateParams", "labelService", "sharedData", "message", "discardChange", function ($rootScope, $state, $scope, $ionicModal,$stateParams,
