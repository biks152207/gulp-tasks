...
ionic.Platform.ready(function () {
    app.run(["$rootScope", "$state", "$templateCache", "$ionicSideMenuDelegate", "$ionicScrollDelegate", "$cordovaStatusbar", "screenSize", "pushNotification", "connectivity", "sharedData", "socket", "orientation", "TodoZuDB", "userModel", "taskService", "$location", "date", "sortService", "taskListView", "platformService", "user", "loggingService", "$ionicPopup", "message", "stringService", "$window", "gAnalytics", "reminderService", "popupService", "$timeout", function ($rootScope, $state, $templateCache, $ionicSideMenuDelegate, $ionicScrollDelegate, $cordovaStatusbar,
