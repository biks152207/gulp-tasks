(function(){
    app.service('reminderService', ["$cordovaLocalNotification", "$rootScope", "$state", "taskService", "date", "reminderModel", "$interval", "message", "userModel", "dbEnums", "$q", "CONSTANT", function ($cordovaLocalNotification, $rootScope, $state, taskService,
