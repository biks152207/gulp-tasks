(function(){
    app.service('rightMenuService', ["$rootScope", "$state", "project", "user", "dbEnums", "message", "sharedData", "date", "notificationService", "userModel", "$ionicPopup", "stringService", "CONSTANT", "$ionicModal", "$ionicLoading", "roleValidators", "sync", "RESPONSE_CODE", "connectivity", "$http", "API", function($rootScope, $state, project, user, dbEnums, message, sharedData,
