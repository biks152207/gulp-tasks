(function () {
    ...
    app.service('filterService', ["$q", "$window", "$rootScope", "labelService", "date", "filterModel", "dbEnums", "message", "sync", function ($q, $window, $rootScope,labelService, date, filterModel,
