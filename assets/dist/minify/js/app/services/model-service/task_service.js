(function () {
    app.service('taskService', ["$q", "$rootScope", "$http", "API", "RESPONSE_CODE", "connectivity", "taskModel", "sortService", "labelService", "userModel", "filterService", "guidGenerator", "dbEnums", "date", "sync", "dueService", "message", "toastService", "$timeout", "$ionicListDelegate", "$state", "sharedData", "reminderModel", "settingsService", "helperService", "roleValidators", function ($q, $rootScope, $http, API, RESPONSE_CODE, connectivity, taskModel, sortService,
