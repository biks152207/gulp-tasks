(function () {
    app.service('settingsService', ["$http", "$rootScope", "$state", "$q", "$window", "API", "RESPONSE_CODE", "Upload", "userModel", "settingsModel", "dbEnums", "message", "sync", "connectivity", "DEFAULTS", function ($http, $rootScope, $state, $q, $window, API, RESPONSE_CODE, Upload,
