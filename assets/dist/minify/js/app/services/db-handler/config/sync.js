(function(){
    app.service('sync', ["$q", "$window", "$http", "$rootScope", "API", "connectivity", "TodoZuDB", "$timeout", "projectModel", "filterModel", "labelModel", "settingsModel", "taskModel", "userModel", "notificationModel", function( $q, $window, $http, $rootScope,
