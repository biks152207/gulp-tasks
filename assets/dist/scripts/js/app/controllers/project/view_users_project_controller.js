(function () {
    app.controller('viewUsersProjectController', ["$rootScope", "$scope", "$state", "$ionicPopup", "$stateParams", "project", "sharedData", "message", "stringService", "userModel", function ($rootScope, $scope, $state, $ionicPopup, $stateParams,
