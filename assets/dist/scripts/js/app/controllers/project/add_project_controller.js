(function () {
    app.controller('addProjectController', ["$rootScope", "$state", "$scope", "$ionicModal", "userModel", "discardChange", "project", "guidGenerator", "dbEnums", "sharedData", "message", "$q", "roleValidators", function ($rootScope, $state, $scope, $ionicModal, userModel,
