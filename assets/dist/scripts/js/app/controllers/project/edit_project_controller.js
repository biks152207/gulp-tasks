(function () {
    app.controller('editProjectController', ["$rootScope", "$state", "$scope", "$ionicModal", "$stateParams", "userModel", "$timeout", "sharedData", "project", "message", "discardChange", function ($rootScope, $state, $scope, $ionicModal, $stateParams, userModel,
