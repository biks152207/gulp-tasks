(function () {
    app.controller('editTaskController', ["$q", "$rootScope", "$scope", "$state", "$ionicModal", "$stateParams", "$timeout", "toastr", "connectivity", "taskService", "dueService", "labelService", "stringService", "headerService", "reminderService", "historyService", "sharedData", "project", "user", "date", "dbEnums", "message", "$ionicPopup", "userModel", "taskListView", "popupService", "$ionicTabsDelegate", "$ionicLoading", "uiHelperService", "$ionicScrollDelegate", "navigationService", "roleValidators", "settingsService", function ($q, $rootScope, $scope, $state, $ionicModal, $stateParams, $timeout, toastr, connectivity,
