(function (){
    app.controller('taskListController', ["$rootScope", "$scope", "$stateParams", "$state", "$timeout", "sortService", "stringService", "filterService", "sharedData", "date", "taskService", "taskListView", "$ionicLoading", "labelService", "project", "dbEnums", "settingsService", "platformService", "userModel", "$ionicScrollDelegate", "message", "uiHelperService", "asyncStackService", "$q", "$ionicLoading", "$location", "roleValidators", function ($rootScope, $scope, $stateParams, $state, $timeout, sortService,
