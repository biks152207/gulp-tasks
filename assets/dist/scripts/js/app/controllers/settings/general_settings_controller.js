(function () {
    app.controller('generalSettingController', ["$rootScope", "$scope", "$state", "$ionicModal", "settingsService", "discardChange", "message", function ($rootScope, $scope, $state, $ionicModal, settingsService, discardChange, message) {
