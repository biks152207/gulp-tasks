(function () {
    app.controller('reminderSettingController', ["$rootScope", "$scope", "settingsService", "$ionicModal", "date", "$state", "message", "reminderService", "discardChange", "roleValidators", "dbEnums", "userModel", "$q", "DEFAULTS", function ($rootScope, $scope, settingsService, $ionicModal, date,
