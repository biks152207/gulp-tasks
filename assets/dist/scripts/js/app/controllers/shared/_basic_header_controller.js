(function () {
    app.controller('basicHeaderController', ["$rootScope", "$state", "$ionicHistory", "$scope", "$ionicPopover", "$ionicLoading", "$ionicSideMenuDelegate", "$ionicPopup", "sharedData", "project", "labelService", "filterService", "user", "rightMenuService", "notificationService", "navigationService", "userModel", function ($rootScope, $state, $ionicHistory, $scope, $ionicPopover, $ionicLoading, $ionicSideMenuDelegate,
