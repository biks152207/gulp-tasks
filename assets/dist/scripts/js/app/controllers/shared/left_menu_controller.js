(function () {
    app.controller('leftMenuController', ["$scope", "$rootScope", "$state", "$ionicPopup", "$ionicScrollDelegate", "$ionicHistory", "project", "labelService", "sharedData", "message", "filterService", "stringService", "sortService", "taskListView", "$q", "$timeout", "userModel", "roleValidators", "dbEnums", function ($scope, $rootScope, $state,  $ionicPopup, $ionicScrollDelegate, $ionicHistory,
