(function(){
    app.service('sortService', ["$window", "stringService", "filterService", "$rootScope", "$q", "$state", "settingsService", "sync", "dbEnums", "userModel", function($window, stringService, filterService, $rootScope, $q, $state,settingsService,sync,dbEnums,userModel){
        var self = this;
