(function () {
    app.service('project', ["$http", "$rootScope", "$q", "$state", "RESPONSE_CODE", "connectivity", "message", "API", "sharedData", "dbEnums", "guidGenerator", "projectModel", "sync", "userModel", "filterService", "taskService", "userRoleValidator", "roleValidators", function ($http, $rootScope, $q, $state, RESPONSE_CODE, connectivity, message,
