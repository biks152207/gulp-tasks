(function(){
    app.service('historyService', ["$q", "$http", "taskService", "connectivity", "API", "RESPONSE_CODE", "message", "userModel", function($q, $http, taskService, connectivity, API, RESPONSE_CODE, message, userModel){
