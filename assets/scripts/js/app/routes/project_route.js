(function() {
    app.config(function($stateProvider) {
        ...
        .state('/accept-invitation', {
            ...
            onEnter: function( $rootScope, $state, $stateParams, message, userModel, project, user, sharedData ) {
        ...
        .state('/approve-admin-invitation', {
            ...
            onEnter: function( $rootScope, $state, $stateParams, message, userModel, project, user, sharedData,stringService,$ionicPopup ) {
