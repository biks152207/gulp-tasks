(function () {
    app.service('pushNotification', function ($rootScope, $state, $q, $window, platformService, userModel, PUSH_NOTIFICATION_CONFIG, $timeout, toastr,$ionicLoading,$ionicPopup,stringService) {
